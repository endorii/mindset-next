...
export function AccountNavigation({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="relative flex gap-[15px] p-[30px] pt-[10px] sm:p-[10px] text-white">
            <button
                className="hidden md:flex top-[75px] fixed w-[40px] h-[40px] items-center justify-center cursor-pointer z-2 bg-white/5 border border-white/10 shadow-lg backdrop-blur-[100px]"
            ...
            >
                ...
                <div className="flex flex-col gap-[10px]">
                    ...
                    <button
                        ...
                        className="flex gap-[15px] py-[13px] items-center bg-black/40 px-[20px] border border-white/10 hover:bg-white group transition-all duration-300 font-perandory tracking-wider text-xl"
                    >
