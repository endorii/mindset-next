                    ...
                    >
                        ...
                        <div className="flex flex-col justify-between w-[150px] gap-[15px]">
                            <div className="flex flex-col gap-[5px]">
                                <div className="bg-white/10 max-w-[120px] h-[25px]"></div>
                                <div className="bg-white/10 h-[25px]"></div>
                            </div>
                            <div className="bg-white/10 h-[25px] max-w-[100px]"></div>
                        </div>
                        <div className="w-[120px] h-[120px] bg-white/10 sm:hidden"></div>
                    </div>
                ))}
            </div>
        </div>
