...
export default function HomePage() {
    ...
    return (
        <div className="relative">
            <h3 className="absolute top-[-30px] left-[50%] translate-x-[-50%] text-xl font-bold text-center text-white text-[200px]">
                Колекції
            </h3>
            {data?.length ? (
                <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 w-full pt-[150px] gap-[20px]">
