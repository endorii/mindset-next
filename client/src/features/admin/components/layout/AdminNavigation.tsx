    ...
    return (
        <div className="fixed pt-[90px] flex h-screen w-full z-[5] text-white">
            ...
            >
                ...
                <div
                    className={`flex flex-col gap-[15px] mt-[50px] rounded-xl bg-white/5 shadow-lg backdrop-blur-[100px] border border-white/5 p-[10px]`}
                >
                ...
                <div
                    className={`flex flex-col gap-[20px] rounded-xl bg-white/5 shadow-lg backdrop-blur-[100px] border border-white/5 p-[10px] ${
                        navOpen ? "justify-start" : "justify-center"
                    }`}
                >
                    <Link
