...
export class TypesService {
    ...
    async addType(userId: string, createTypeDto: CreateTypeDto) {
        try {
            ...
            await this.recentActions.createAction(userId, `Додано тип ${type.name}`);
    ...
    async editType(userId: string, typeId: string, updateTypeDto: UpdateTypeDto) {
        try {
            ...
            await this.recentActions.createAction(userId, `Редаговано тип ${updatedType.name}`);
    ...
    async deleteType(userId: string, typeId: string) {
        try {
            ...
            await this.recentActions.createAction(userId, `Видалено тип ${type.name}`);
